...
bool manipulator_interface__msg__log_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("manipulator_interface.msg._log_msg.LogMsg", full_classname_dest, 41) == 0);
  }
  manipulator_interface__msg__LogMsg * ros_message = _ros_message;
  {  // log
...
PyObject * manipulator_interface__msg__log_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("manipulator_interface.msg._log_msg");
