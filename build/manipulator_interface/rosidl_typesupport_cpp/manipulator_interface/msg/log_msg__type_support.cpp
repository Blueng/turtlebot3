...
static const _LogMsg_type_support_symbol_names_t _LogMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulator_interface, msg, LogMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, manipulator_interface, msg, LogMsg)),
  }
};
...
get_message_type_support_handle<manipulator_interface::msg::LogMsg>()
{
  return &::manipulator_interface::msg::rosidl_typesupport_cpp::LogMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, manipulator_interface, msg, LogMsg)() {
  return get_message_type_support_handle<manipulator_interface::msg::LogMsg>();
}
